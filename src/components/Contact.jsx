...
const Contact = () => {
  return (
    <div name='contacts' className='w-full h-screen bg-gradient-to-b from-[#E1E1E1] to-[#ADADAD] dark:bg-gradient-to-b dark:from-[#1B1B1B] dark:to-[#100F0F] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/bgddvvna"  className='flex flex-col max-w-[600px] w-full'>
          <div className='pb-5'>
          ...
          <button className='bg-[#D8843B] text-white font-semibold w-[180px] rounded-md my-6 mx-auto py-3 shadow-xl hover:shadow-lg hover:bg-black hover:text-[#D8843B] ease-in-out duration-500' target = '_blank'>Let's Collaborate</button>
        </form>
    </div>
  )
}
